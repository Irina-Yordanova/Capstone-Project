...
def get_pie_chart(site_dropdown):
    ...
    if site_dropdown=='ALL':
        ...
        success=filtered_df.groupby('class').size().reset_index(name='count')
        fig=px.pie(success,values='count',
        names='class',
        title=f'Successful vs failed attempts for {site_dropdown}')
        return fig
...
def funct(site_dropdown,payload_slider):
    if(site_dropdown=='ALL'):
